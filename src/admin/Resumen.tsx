  ...
  return (
    <div className="space-y-6 text-[var(--app-ink)]">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link to={adminBasePath} className="app-surface-soft block p-6 transition hover:translate-y-[-1px]">
        ...
        <Link to={`${adminBasePath}/desplazamientos`} className="app-surface-soft block p-6 transition hover:translate-y-[-1px]">
        ...
        <Link to={`${adminBasePath}/checklist`} className="app-surface-soft block p-6 transition hover:translate-y-[-1px]">
        ...
        <Link to={`${adminBasePath}/chat`} className="app-surface-soft block p-6 transition hover:translate-y-[-1px]">
      ...
      <section className="app-surface p-6 text-center sm:p-8">
        <h2 className="text-2xl font-semibold tracking-[-0.04em] sm:text-3xl">Todo listo para el gran día</h2>
