...
export async function obtenerCanciones() {
    if (!supabaseConfig.enabled) {
        return readStorageWithSchema(STORAGE_KEY, songsSchema, []);
    }
    // FUTURO: Supabase
...
// -------------------------
export async function guardarCanciones(canciones) {
    if (!supabaseConfig.enabled) {
...
// -------------------------
export async function guardarCancion(cancion) {
...
// -------------------------
export async function votarCancion(id) {
    const canciones = await obtenerCanciones();
