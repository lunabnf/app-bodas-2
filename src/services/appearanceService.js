...
export function getAppearanceSettings() {
    ...
    const parsed = readStorageWithSchema(STORAGE_KEY, appearanceSettingsSchema, defaultAppearanceSettings);
    return {
...
export function applyAppearanceSettings(settings) {
    ...
    root.style.setProperty("--app-surface-soft-bg", `rgba(255, 255, 255, ${settings.softSurfaceOpacity})`);
}
